...
Partial Class Form_SysTaskBarProgress
    ...
    Private Sub InitializeComponent()
        ...
        Panel4.Location = New Point(20, 305)
        Panel4.Name = "Panel4"
        Panel4.Padding = New Padding(0, 10, 0, 0)
        Panel4.Size = New Size(591, 45)
        Panel4.TabIndex = 55
        ' 
        ' ModernButton12
        ...
        ' Panel2
        ' 
        Panel2.Controls.Add(ModernButton8)
        ...
        Label6.TabIndex = 39
        Label6.Text = "Windows 各主版本都有自己的显示效果"
        ' 
        ' Panel1
        ' 
        ...
        Label1.TabIndex = 34
        Label1.Text = "系统任务栏进度显示类 SysTaskBarProgress"
        ' 
        ' Form_SysTaskBarProgress
        ' 
        AutoScaleDimensions = New SizeF(96F, 96F)
        AutoScaleMode = AutoScaleMode.Dpi
        BackColor = Color.FromArgb(CByte(36), CByte(36), CByte(36))
        ClientSize = New Size(631, 595)
        Controls.Add(ModernPanel1)
        Font = New Font("Microsoft YaHei UI", 10F)
        ForeColor = Color.Silver
        Name = "Form_SysTaskBarProgress"
        Text = "Form_SysTaskBarProgress"
