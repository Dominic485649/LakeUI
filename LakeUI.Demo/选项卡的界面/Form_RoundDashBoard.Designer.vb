...
Partial Class Form_RoundDashBoard
    ...
    Private Sub InitializeComponent()
        ...
        ' RoundDashBoard3
        ' 
        RoundDashBoard3.AnimationDuration = 1000
        RoundDashBoard3.AnimationFPS = 0
        RoundDashBoard3.Dock = DockStyle.Left
        RoundDashBoard3.FillGradientColor = Color.FromArgb(CByte(192), CByte(0), CByte(192))
        RoundDashBoard3.Location = New Point(0, 0)
        RoundDashBoard3.Margin = New Padding(2, 2, 2, 2)
        RoundDashBoard3.Name = "RoundDashBoard3"
        RoundDashBoard3.Size = New Size(100, 100)
        RoundDashBoard3.TabIndex = 2
        ' 
        ' Label7
        ' 
        ...
        ' RoundDashBoard1
        ' 
        RoundDashBoard1.Dock = DockStyle.Left
        RoundDashBoard1.Location = New Point(0, 0)
        RoundDashBoard1.Margin = New Padding(2, 2, 2, 2)
        RoundDashBoard1.Name = "RoundDashBoard1"
        RoundDashBoard1.Size = New Size(100, 100)
        RoundDashBoard1.TabIndex = 0
        ...
        Label1.TabIndex = 34
        Label1.Text = "圆形仪表盘 RoundDashBoard"
        ' 
        ' Form_RoundDashBoard
        ' 
        ...
        Name = "Form_RoundDashBoard"
        Text = "Form_RoundDashBoard"
