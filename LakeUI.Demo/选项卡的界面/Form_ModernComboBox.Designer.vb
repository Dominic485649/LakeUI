...
Partial Class Form_ModernComboBox
    ...
    Private Sub InitializeComponent()
        ...
        Panel3.BorderSize = 0
        ModernComboBox2 = New ModernComboBox()
        ...
        ' Panel4
        ' 
        Panel4.Controls.Add(ModernComboBox3)
        Panel4.Dock = DockStyle.Top
        Panel4.Location = New Point(20, 340)
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(702, 35)
        Panel4.TabIndex = 44
        ' 
        ' ModernComboBox3
        ' 
        ...
        ModernComboBox3.Items.Add("下拉选项2")
        ...
        ModernComboBox3.Padding = New Padding(12, 0, 8, 0)
        ModernComboBox3.PressedBackColor2 = SystemColors.WindowFrame
        ModernComboBox3.Size = New Size(217, 35)
        ModernComboBox3.TabIndex = 21
        ModernComboBox3.Text = "ModernComboBox3"
        ModernComboBox3.ToolTipBorderSize = 2
        ModernComboBox3.ToolTipGap = 10
        ModernComboBox3.WaterText = "水印文字"
        ' 
        ' Label7
        ' 
        ...
        ModernComboBox2.Items.Add("下拉选项1")
        ModernComboBox2.Items.Add("下拉选项2")
        ...
        ModernComboBox2.Padding = New Padding(12, 0, 8, 0)
        ModernComboBox2.PressedBackColor2 = SystemColors.WindowFrame
        ModernComboBox2.Size = New Size(217, 35)
        ModernComboBox2.TabIndex = 21
        ModernComboBox2.Text = "ModernComboBox2"
        ModernComboBox2.ToolTipBorderSize = 2
        ModernComboBox2.ToolTipGap = 10
        ModernComboBox2.WaterText = "水印文字"
        ' 
        ' Label5
        ' 
        ...
        ModernComboBox1.Items.Add("下拉选项2")
        ...
        ModernComboBox1.Padding = New Padding(12, 0, 8, 0)
        ModernComboBox1.PressedBackColor2 = SystemColors.WindowFrame
        ModernComboBox1.Size = New Size(217, 35)
        ModernComboBox1.TabIndex = 21
        ...
        Label1.TabIndex = 34
        Label1.Text = "现代化下拉框 ModernComboBox"
        ' 
        ' Form_ModernComboBox
        ' 
        ...
        ClientSize = New Size(742, 610)
        Controls.Add(ModernPanel1)
        ForeColor = Color.Silver
        Name = "Form_ModernComboBox"
    ...
    Friend WithEvents ModernComboBox2 As ModernComboBox
