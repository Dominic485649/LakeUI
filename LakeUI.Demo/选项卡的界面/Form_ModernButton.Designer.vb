...
Partial Class Form_ModernButton
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 34
        Label1.Text = "现代化按钮 ModernButton"
        ' 
        ' Form_ModernButton
        ' 
        ...
        ClientSize = New Size(683, 629)
        Controls.Add(ModernPanel1)
        ForeColor = Color.Silver
        Margin = New Padding(2)
        Name = "Form_ModernButton"
        Text = "Form_ModernButton"
    ...
    Friend WithEvents Label10 As HtmlColorLabel
End Class
