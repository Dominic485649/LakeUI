...
Partial Class Form_MsgBox_InputBox_Tip
    ...
    Private Sub InitializeComponent()
        ...
        JustEmptyControl3 = New JustEmptyControl()
        ...
        ModernPanel1.Size = New Size(700, 623)
        ModernPanel1.TabIndex = 40
        ' 
        ' Panel6
        ' 
        Panel6.Controls.Add(ModernButton11)
        Panel6.Controls.Add(JustEmptyControl3)
        Panel6.Controls.Add(ModernButton12)
        Panel6.Dock = DockStyle.Top
        Panel6.Location = New Point(20, 510)
        Panel6.Name = "Panel6"
        Panel6.Size = New Size(660, 35)
        Panel6.TabIndex = 49
        ' 
        ' ModernButton11
        ...
        JustEmptyControl3.Location = New Point(187, 0)
        ...
        Label9.Location = New Point(20, 460)
        Label9.Name = "Label9"
        Label9.Padding = New Padding(0, 20, 0, 10)
        Label9.Size = New Size(100, 50)
        Label9.TabIndex = 48
        Label9.Text = "ExFloatingTip"
        ' 
        ' Panel5
        ' 
        Panel5.Controls.Add(ModernButton9)
        Panel5.Dock = DockStyle.Top
        Panel5.Location = New Point(20, 425)
        Panel5.Name = "Panel5"
        Panel5.Size = New Size(660, 35)
        Panel5.TabIndex = 47
        ' 
        ' ModernButton9
        ...
        Label8.Size = New Size(85, 50)
        Label8.TabIndex = 46
        Label8.Text = "ExInputBox"
        ' 
        ' Panel4
        ' 
        Panel4.Controls.Add(ModernButton10)
        Panel4.Dock = DockStyle.Top
        Panel4.Location = New Point(20, 340)
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(660, 35)
        Panel4.TabIndex = 45
        ' 
        ' ModernButton10
        ...
        Label7.Size = New Size(104, 50)
        Label7.TabIndex = 44
        Label7.Text = "ExFloatingBox"
        ' 
        ' Panel3
        ' 
        Panel3.Controls.Add(ModernButton7)
        Panel3.Controls.Add(JustEmptyControl2)
        Panel3.Controls.Add(ModernButton8)
        Panel3.Dock = DockStyle.Top
        Panel3.Location = New Point(20, 255)
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(660, 35)
        Panel3.TabIndex = 43
        ' 
        ' ModernButton7
        ...
        JustEmptyControl2.Location = New Point(158, 0)
        JustEmptyControl2.Name = "JustEmptyControl2"
        JustEmptyControl2.Size = New Size(10, 35)
        ...
        JustEmptyControl1.Location = New Point(288, 0)
        JustEmptyControl1.Name = "JustEmptyControl1"
        JustEmptyControl1.Size = New Size(10, 35)
        ...
        Label6.Size = New Size(78, 50)
        Label6.TabIndex = 38
        Label6.Text = "ExMsgBox"
        ' 
        ' Panel1
        ' 
        ...
        Label1.Size = New Size(535, 50)
        Label1.TabIndex = 34
        Label1.Text = "消息框 / 输入框 / 提示 | MsgBox / InputBox / Tip"
        ' 
        ' Form_MsgBox_InputBox_Tip
        ' 
        AutoScaleDimensions = New SizeF(96F, 96F)
        AutoScaleMode = AutoScaleMode.Dpi
        BackColor = Color.FromArgb(CByte(36), CByte(36), CByte(36))
        ClientSize = New Size(700, 623)
        Controls.Add(ModernPanel1)
        Font = New Font("Microsoft YaHei UI", 10F)
        ForeColor = Color.Silver
        Name = "Form_MsgBox_InputBox_Tip"
        Text = "Form_MsgBox_InputBox_Tip"
    ...
    Friend WithEvents JustEmptyControl3 As JustEmptyControl
