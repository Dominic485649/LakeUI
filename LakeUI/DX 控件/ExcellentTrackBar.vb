...
#Region "属性"
    ...
    Private ReadOnly 动画助手 As New D3D_AnimationHelper(Me) With {.Duration = 0}

    Private Sub 滑块动画脏区(helper As D3D_AnimationHelper, owner As Control, sink As D3D_AnimationHelper.InvalidateRegionSink)
        sink.InvalidateAll()
    End Sub
